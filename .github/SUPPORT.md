...
Thank you for using `brainflowprobes`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/brainflowprobes`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/brainflowprobes),
...
[search issues and pull requests](https://github.com/LieberInstitute/brainflowprobes/issues)
